...
/*   Updated: 2024/04/20 16:01:17 by dconza           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_fractal_options(void)
{
	...
	ft_putendl_fd("\e[36mExemple d'utilisation :\t./fractol <type>\e[0m", 1);
	ft_putstr_fd("\nPour Julia, spécifiez les valeurs de départ\n", 1);
	ft_putstr_fd("Les valeurs doivent être comprises\n", 1);
...
void	print_color_options(void)
{
	...
	ft_putendl_fd("Choisissez une couleur avec un code hexadécimal.", 1);
	ft_putendl_fd("Le code couleur hexadécimal  'RRGGBB' :", 1);
	...
	ft_putendl_fd("\nPour Julia, spécifiez les couleurs qu'après", 1);
